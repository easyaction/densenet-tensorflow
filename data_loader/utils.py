...
<html lang="en">
  ...
  <title>vision_networks/utils.py at master · ikhlestov/vision_networks</title>
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MTE2MzA5NzkwOmE5ZWQzODYyYzkyMTFiN2JkZjFjYTYyMTBjNTk0ZjlmNDNiM2NkMGNjZDMwYTg3MjMwMTY4ZDNlMWYzZmNkYzg=--230212f1e1ee11e6f8612e67581ec2e83e02861e">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="ADA2:28177:43E546E:692D0D6:59B24239" data-pjax-transient>
...
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="easyaction">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta content="9900548" name="octolytics-dimension-user_id" /><meta content="ikhlestov" name="octolytics-dimension-user_login" /><meta content="80234478" name="octolytics-dimension-repository_id" /><meta content="ikhlestov/vision_networks" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="80234478" name="octolytics-dimension-repository_network_root_id" /><meta content="ikhlestov/vision_networks" name="octolytics-dimension-repository_network_root_nwo" /><meta content="false" name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" />
    ...
    <link rel="canonical" href="https://github.com/ikhlestov/vision_networks/blob/master/data_providers/utils.py" data-pjax-transient>
...
<header class="Header  f5" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/ikhlestov/vision_networks/search" class="js-site-search-form" data-scoped-search-url="/ikhlestov/vision_networks/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/ikhlestov/vision_networks/blob/master/data_providers/utils.py" class="header-search-scope no-underline">This repository</a>
      <input type="text"
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details js-dropdown-details d-flex pl-2 flex-items-center">
      ...
      <ul class="dropdown-menu dropdown-menu-sw">
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="P9ULfdpW9IdfnYOoMT8AbUlsMSW7ZqLW1GDoo2A3F5zZtRFQ8V3oyGmrglrH5v0QsafcnZk9POGj0JQrsGAj4g==" /></div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="RDtilA6T4of+v73sylsadorXdgr+HVWI+x5HPcNqdhGiW3i5JZj+yMiJvB48gucLchybstxGy7+Mrju1Ez1Cbw==" /></div>
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="o+LIYqSFs34pTTfAz1mEDGXC6ohRK5iiwzjeoizx9zhteAa2gVaU7x6gdlWTMbzckqIRvhbsvx1ANX76fvkDHw==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="80234478" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/ikhlestov/vision_networks/unstar" class="starred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="gYeKPjZEYfaQE1kTvT5LD18L17m1QseMicKBTyJ5eu6PARWQO7rTiVGdyLpAK4GErtLfaRV60icCZQPZNypHUA==" /></div>
      <button
        type="submit"
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/ikhlestov/vision_networks/star" class="unstarred" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="OAfWHmSg/Tjmr1oBNdbZKNfRxqvhcOLgznbds9oTgrPW2v7soOwQD7h80v63VyCQCaXGNISge84PG4//2yVERg==" /></div>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
...
<div class="container new-discussion-timeline experiment-repo-nav">
  ...
  <a href="/ikhlestov/vision_networks/blob/5bccafd64c8d9303dfdad0abd6dc5edf95468590/data_providers/utils.py" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:1da6191e387e63c6ccdebc7c32af2be2 -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/ikhlestov/vision_networks/blob/master/data_providers/utils.py"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
  ...
  <include-fragment class="commit-tease" src="/ikhlestov/vision_networks/contributors/master/data_providers/utils.py">
    <div>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/ikhlestov/vision_networks/raw/master/data_providers/utils.py" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/ikhlestov/vision_networks/blame/master/data_providers/utils.py" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/ikhlestov/vision_networks/commits/master/data_providers/utils.py" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/ikhlestov/vision_networks/edit/master/data_providers/utils.py" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="N/dqy3Flli1nM5iU4Rckupev591gb1M2eQ4OiYgr2d8UU6wThd+cehJjYIJJnSppm/lRTp4pHIsTARhQpALHQg==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/ikhlestov/vision_networks/delete/master/data_providers/utils.py" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="rPzxN0z1pNmD2LYB7HjvH+KDIlchZrxHe4uYUtKLwzxlnmgYCXdhFCROQFTUJ8XqlcR+pXp2INde22EiMBqMbg==" /></div>
  ...
  <div itemprop="text" class="blob-wrapper data type-python">
      ...
      <tr>
        ...
        <td id="LC1" class="blob-code blob-code-inner js-file-line"><span class="pl-k">from</span> .cifar <span class="pl-k">import</span> Cifar10DataProvider, Cifar100DataProvider, \</td>
      </tr>
      <tr>
        <td id="L2" class="blob-num js-line-number" data-line-number="2"></td>
        <td id="LC2" class="blob-code blob-code-inner js-file-line">    Cifar10AugmentedDataProvider, Cifar100AugmentedDataProvider</td>
      </tr>
      <tr>
        <td id="L3" class="blob-num js-line-number" data-line-number="3"></td>
        <td id="LC3" class="blob-code blob-code-inner js-file-line"><span class="pl-k">from</span> .svhn <span class="pl-k">import</span> SVHNDataProvider</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC6" class="blob-code blob-code-inner js-file-line"><span class="pl-k">def</span> <span class="pl-en">get_data_provider_by_name</span>(<span class="pl-smi">name</span>, <span class="pl-smi">train_params</span>):</td>
      </tr>
      <tr>
        <td id="L7" class="blob-num js-line-number" data-line-number="7"></td>
        <td id="LC7" class="blob-code blob-code-inner js-file-line">    <span class="pl-s"><span class="pl-pds">&quot;&quot;&quot;</span>Return required data provider class<span class="pl-pds">&quot;&quot;&quot;</span></span></td>
      </tr>
      <tr>
        <td id="L8" class="blob-num js-line-number" data-line-number="8"></td>
        <td id="LC8" class="blob-code blob-code-inner js-file-line">    <span class="pl-k">if</span> name <span class="pl-k">==</span> <span class="pl-s"><span class="pl-pds">&#39;</span>C10<span class="pl-pds">&#39;</span></span>:</td>
      </tr>
      <tr>
        <td id="L9" class="blob-num js-line-number" data-line-number="9"></td>
        <td id="LC9" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">return</span> Cifar10DataProvider(<span class="pl-k">**</span>train_params)</td>
      </tr>
      <tr>
        <td id="L10" class="blob-num js-line-number" data-line-number="10"></td>
        <td id="LC10" class="blob-code blob-code-inner js-file-line">    <span class="pl-k">if</span> name <span class="pl-k">==</span> <span class="pl-s"><span class="pl-pds">&#39;</span>C10+<span class="pl-pds">&#39;</span></span>:</td>
      </tr>
      <tr>
        <td id="L11" class="blob-num js-line-number" data-line-number="11"></td>
        <td id="LC11" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">return</span> Cifar10AugmentedDataProvider(<span class="pl-k">**</span>train_params)</td>
      </tr>
      <tr>
        <td id="L12" class="blob-num js-line-number" data-line-number="12"></td>
        <td id="LC12" class="blob-code blob-code-inner js-file-line">    <span class="pl-k">if</span> name <span class="pl-k">==</span> <span class="pl-s"><span class="pl-pds">&#39;</span>C100<span class="pl-pds">&#39;</span></span>:</td>
      </tr>
      <tr>
        <td id="L13" class="blob-num js-line-number" data-line-number="13"></td>
        <td id="LC13" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">return</span> Cifar100DataProvider(<span class="pl-k">**</span>train_params)</td>
      </tr>
      <tr>
        <td id="L14" class="blob-num js-line-number" data-line-number="14"></td>
        <td id="LC14" class="blob-code blob-code-inner js-file-line">    <span class="pl-k">if</span> name <span class="pl-k">==</span> <span class="pl-s"><span class="pl-pds">&#39;</span>C100+<span class="pl-pds">&#39;</span></span>:</td>
      </tr>
      <tr>
        <td id="L15" class="blob-num js-line-number" data-line-number="15"></td>
        <td id="LC15" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">return</span> Cifar100AugmentedDataProvider(<span class="pl-k">**</span>train_params)</td>
      </tr>
      <tr>
        <td id="L16" class="blob-num js-line-number" data-line-number="16"></td>
        <td id="LC16" class="blob-code blob-code-inner js-file-line">    <span class="pl-k">if</span> name <span class="pl-k">==</span> <span class="pl-s"><span class="pl-pds">&#39;</span>SVHN<span class="pl-pds">&#39;</span></span>:</td>
      </tr>
      <tr>
        <td id="L17" class="blob-num js-line-number" data-line-number="17"></td>
        <td id="LC17" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">return</span> SVHNDataProvider(<span class="pl-k">**</span>train_params)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC19" class="blob-code blob-code-inner js-file-line">        <span class="pl-c1">print</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>Sorry, data provider for `<span class="pl-c1">%s</span>` dataset <span class="pl-pds">&quot;</span></span></td>
      </tr>
      <tr>
        <td id="L20" class="blob-num js-line-number" data-line-number="20"></td>
        <td id="LC20" class="blob-code blob-code-inner js-file-line">              <span class="pl-s"><span class="pl-pds">&quot;</span>was not implemented yet<span class="pl-pds">&quot;</span></span> <span class="pl-k">%</span> name)</td>
      </tr>
      <tr>
  ...
  <div class="BlobToolbar position-absolute js-file-line-actions dropdown js-menu-container js-select-menu d-none" aria-hidden="true">
    ...
    <div class="dropdown-menu-content js-menu-content" id="inline-file-actions">
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a href="/ikhlestov/vision_networks/blame/5bccafd64c8d9303dfdad0abd6dc5edf95468590/data_providers/utils.py" class="dropdown-item js-update-url-with-hash" id="js-view-git-blame">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between py-6 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2017 <span title="0.79119s from unicorn-1655995916-fp8gl">GitHub</span>, Inc.</li>
